  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row w-[85%] lg:w-[75%] rounded-[20px] lg:rounded-r-[20px] 2xl:w-[65%] bg-[#161616] my-[5vh] mx-auto'>
        <div className='flex flex-col w-full lg:w-[67%] pb-8 pt-4 lg:py-10 px-5 lg:px-10 '>
            <h2 className='flex flex-wrap capitalize tracking-wide text-[2rem] py-2 lg:py-0 lg:text-mh-d font-[400] text-w-1 leading-tight'>{mainHead}</h2>
        ...
        <div className='flex flex-wrap w-full lg:w-[33%] capitalize bg-cover bg-center bg-ContactCard px-5 py-10 rounded-[20px]' >
            <h2 className='flex flex-wrap text-[2rem] lg:text-mh-d font-[400] text-w-1 leading-tight'>{subHead}</h2>
