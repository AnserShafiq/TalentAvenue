...
const IndustryCard = ({title, desc, link, profile}) => {
  return (
    <div className='flex flex-col relative shadow-md shadow-[#bd996013] bg-[#0000006f] rounded-[25px]'>
        <img className='rounded-t-[25px] lg:h-[250px]' src={profile} alt={`${title}'s Pic`} />
