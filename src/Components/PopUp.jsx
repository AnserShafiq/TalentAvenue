...
export default function Popup({children, btnCSS}) {
    ...
    const DataDisplay = (props) => {
        return props.trigger ? (
            <div className='fixed z-[10] top-0 left-0 h-full w-full flex flex-col items-center justify-center bg-[#000000cf]'>
        ...
        <div className=''>
            ...
            <DataDisplay trigger={popupCall} setTrigger={setPopupCall}>
                <div className='flex flex-col justify-end h-full pb-8 lg:pb-12'>
                    <div className='font-bold capitalize tracking-wide text-[1.5rem] lg:text-[1.8rem] leading-relaxed mb-4'><Underlining bodytext={'What are you looking for?'} textcolor={'w-1'}/></div>
                    <div className='flex flex-col items-center'>
                        <Link className='px-3 py-[1.5%] capitalize text-g-1 rounded-[20px] border-2 text-[1.1rem] lg:text-[1.3rem] bg-[#00000055] hover:bg-black tranisition-transform duration-[0.5s] ease-in-out hover:scale-[1.05]  border-g-1 w-fit mb-4' to='/job-seekers/application-form'>Looking for jobs </Link>
                        <Link className='px-3 py-[1.5%] capitalize text-g-1 rounded-[20px] border-2 text-[1.1rem] lg:text-[1.3rem] bg-[#00000055] hover:bg-black tranisition-transform duration-[0.5s] ease-in-out hover:scale-[1.05]  border-g-1 w-fit' to='/employers/application-form'>Looking for candidates</Link>
                    </div>
                </div>
        </DataDisplay>
        </div>
