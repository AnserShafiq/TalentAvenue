  ...
  return (
    <div className='flex flex-col my-[10%] lg:my-sm w-[95%] lg:w-[80%] 2xl:w-[70%] mx-auto'>
        ...
        <div className='flex flex-col lg:flex-row items-center justify-around mt-5'>
            ...
            <div className='flex flex-col w-[300px] lg:w-[370px] items-center my-4 lg:my-0 py-4 lg:py-8 px-8 rounded-[20px] bg-transparent-black-70'>
                <Mail className='text-[5rem] text-g-1' />
                <h3 className='text-[1.7rem] lg:text-[2rem] font-semibold uppercase text-g-1 mt-2'>
                    To Mail Us
                </h3>
                <Link className='text-[1.2rem] lg:text-[1.5rem] text-w-1 border-b-[1px] border-transparent hover:border-g-1' to={'mailto:info@talentavenue.ca'}>info@talentavenue.ca</Link>
            </div>
            ...
            <div className='flex flex-col w-[300px] lg:w-[370px] items-center my-4 lg:my-0 py-4 lg:py-8  px-8 rounded-[20px] bg-transparent-black-70'>
                ...
                <Link className='text-[1.2rem] lg:text-[1.5rem] text-w-1 border-b-[1px] border-transparent hover:border-g-1' to={'mailto:info@talentavenue.ca'}>(123) 456 7890</Link>
            </div>
            ...
            <div className='flex flex-col w-[300px] lg:w-[370px] items-center my-4 lg:my-0 py-4 lg:py-8  px-8 rounded-[20px] bg-transparent-black-70'>
                ...
                <Link className='text-[1.2rem] lg:text-[1.5rem] text-w-1 border-b-[1px] border-transparent hover:border-g-1 text-center' to={'mailto:info@talentavenue.ca'}>2424 Finch Ave W#18, Torontto, Canada </Link>
            </div>
