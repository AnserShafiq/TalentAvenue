  ...
  return (
    <div className='flex flex-col my-[10%] lg:my-sm w-[95%] lg:w-[80%] 2xl:w-[70%] mx-auto'>
        ...
        <div className='flex flex-col lg:flex-row items-center justify-around mt-5'>
            ...
            <div className='flex flex-row w-[300px] lg:w-[400px] lg:min-h-[193px] items-center my-4 lg:my-0 py-4 lg:py-8 px-8 rounded-[20px] bg-transparent-black-70'>
            ...
            <div className='flex flex-row w-[300px] lg:w-[440px] lg:min-h-[193px] items-start my-4 lg:my-0 py-4 lg:py-8 px-8 rounded-[20px] bg-transparent-black-70'>
                <Office className='text-[8rem] text-g-1' />
                <div className='flex flex-col ml-6'>
                <h3 className='text-[1.7rem] lg:text-[2rem] font-semibold uppercase text-g-1 mt-2'>
                    Our Location
                </h3>
                <Link className='text-[1.2rem] lg:text-[1.5rem] text-w-1 border-b-[1px] border-transparent transition-all duration-[0.3s] hover:text-g-1 hover:underline hover:scale-[1.04] text-start' to={'https://maps.app.goo.gl/jAUJxjmrhxccyX2y8'}>2424 Finch Ave W#18, Toronto, Canada </Link>
                </div>
            </div>
