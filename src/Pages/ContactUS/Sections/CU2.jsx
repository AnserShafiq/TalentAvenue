...
const CU2 = () => {
    ...
    // Thank you for contacting us, our team will reach back to you as soon as possible.
    return (
    <div className="flex flex-col lg:flex-row my-[10%] lg:mt-10 lg:mb-14 w-[95%] lg:w-[80%] 2xl:w-[70%] mx-auto">
      ...
      <div className="lg:w-[50%] lg:sticky lg:top-[10%]">
        <img
          className="h-[50vh] lg:h-full lg:min-h-[72.7vh] w-full object-cover rounded-[20px]"
          src={SidePic}
          alt="Contact Us Form"
        />
      </div>

      <div className="flex flex-col justify-start items-start py-6 lg:py-0 px-6 lg:px-10 lg:w-[50%]">
        ...
        {
          emailSent? (
            <div className='flex w-full text-start text-[1.5rem] uppercase font-bold text-g-1'>
              Thank you for contacting us, our team will reach back to you as soon as possible.
            </div>
          ):(
