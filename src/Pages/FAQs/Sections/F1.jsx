...
const F1 = () => {
    ...
    return (
        ...
        />
        <div className='flex flex-col lg:flex-row items-center bg-[#303030AD] lg:bg-transparent rounded-[20px] text-center lg:text-start absolute w-[90%] lg:w-[43%] mx-auto lg:mx-0 max-w-[1350px] px-[3%] lg:ml-[3%] lg:px-[5%] py-[5%] lg:py-[2%] bottom-[7%] lg:top-0 lg:left-0 lg:h-full'> 
