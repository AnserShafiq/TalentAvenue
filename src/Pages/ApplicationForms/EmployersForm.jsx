...
const FormStructure = () => {
    ...
    return emailSent? (
        <div className="flex w-full h-[50vh] bg-[#323337] justify-center text-center items-center text-mh-m lg:text-mh-d uppercase font-bold tracking-wide tracking-wide text-g-1 px-10">
            Thank you for your time, our team will reach back to you as soon as possible.
        </div>
    ):(
...
export const EmployersFormData = {
    Left: {
        ...
        Description: "Let us know the position you need to fill, and Talent Avenue will help you find the right fit. Please complete the form below, and we'll contact you to initiate the recruitment process."
    },
    Right: () => <FormStructure />
}